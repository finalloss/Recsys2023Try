...
for iter in range(146,149):
    ...
    # training
    # 当筛选特征之后需要相应地修改nume_fea_size  目前38/16/10/9/5/3
    model = DeepFM(feature_sizes, embedding_size=2,nume_fea_size=16,
