...
# 划分训练集和验证集 
if click_feature:
    train_x,val_x,train_y,val_y = train_test_split(X_train,y_click,test_size=0.1,stratify=y_click)
else:
    train_x,val_x,train_y,val_y = train_test_split(X_train,y_install,test_size=0.1,stratify=y_install)
